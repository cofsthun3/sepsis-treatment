...
ii=isnan(reformatsah(:,23))&isnan(reformatsah(:,25))&(reformatsah(:,22)==0|reformatsah(:,22)==2);  %no fio2 given and o2flow given, no interface OR cannula
reformat(ii,23)=21;
...
ii=isnan(reformatsah(:,23))&isnan(reformatsah(:,25))&(isnan(reformatsah(:,22))|reformatsah(:,22)==1|reformatsah(:,22)==3|reformatsah(:,22)==4|reformatsah(:,22)==5|reformatsah(:,22)==6|reformatsah(:,22)==9|reformatsah(:,22)==10);  %no fio2 given and o2flow given, no interface OR cannula
reformat(ii,23)=NaN;
...
tic
     save('e:\BACKUPMITPC\Data_100219.mat', '-v7.3');
toc
...
tic
     save('e:\BACKUPMITPC\Data_110219.mat', '-v7.3');
toc
