...
tic
abx=table2array(readtable('e:/exportdir/abx.csv'));
culture=table2array(readtable('e:/exportdir/culture.csv'));
microbio=table2array(readtable('e:/exportdir/microbio.csv'));
demog=(readtable('e:/exportdir/demog.csv'));
ce010=table2array(readtable('e:/exportdir/ce010000.csv'));
ce1020=table2array(readtable('e:/exportdir/ce1000020000.csv'));
ce2030=table2array(readtable('e:/exportdir/ce2000030000.csv'));
ce3040=table2array(readtable('e:/exportdir/ce3000040000.csv'));
ce4050=table2array(readtable('e:/exportdir/ce4000050000.csv'));
ce5060=table2array(readtable('e:/exportdir/ce5000060000.csv'));
ce6070=table2array(readtable('e:/exportdir/ce6000070000.csv'));
ce7080=table2array(readtable('e:/exportdir/ce7000080000.csv'));
ce8090=table2array(readtable('e:/exportdir/ce8000090000.csv'));
ce90100=table2array(readtable('e:/exportdir/ce90000100000.csv'));
labU=[ table2array(readtable('e:/exportdir/labs_ce.csv')) ; table2array(readtable('e:/exportdir/labs_le.csv'))  ];
MV=table2array(readtable('e:/exportdir/mechvent.csv'));
inputpreadm=table2array(readtable('e:/exportdir/preadm_fluid.csv'));
inputMV=table2array(readtable('e:/exportdir/fluid_mv.csv'));
inputCV=table2array(readtable('e:/exportdir/fluid_cv.csv'));
vasoMV=table2array(readtable('e:/exportdir/vaso_mv.csv'));
vasoCV=table2array(readtable('e:/exportdir/vaso_cv.csv'));
UOpreadm=table2array(readtable('e:/exportdir/preadm_uo.csv'));
UO=table2array(readtable('e:/exportdir/uo.csv'));
toc
...
ii=find(isnan(reformatsah(:,23))&~isnan(reformatsah(:,25))&(isnan(reformatsah(:,22))|reformatsah(:,22)==1|reformatsah(:,22)==3|reformatsah(:,22)==4|reformatsah(:,22)==5|reformatsah(:,22)==6|reformatsah(:,22)==9|reformatsah(:,22)==10)); 
...
ii=find(isnan(reformatsah(:,23))&isnan(reformatsah(:,25))&(isnan(reformatsah(:,22))|reformatsah(:,22)==1|reformatsah(:,22)==3|reformatsah(:,22)==4|reformatsah(:,22)==5|reformatsah(:,22)==6|reformatsah(:,22)==9|reformatsah(:,22)==10));  %no fio2 given and o2flow given, no interface OR cannula
reformat(ii,23)=NaN;
